...
export function setup() {
    ...
    if (ids.length === 0) { throw new Error('UserDocument ID listesi boş'); }
...
export default function (ids) {
    ...
    mutation ($id: ID!, $n: String!, $e: String!) {
      updateUserDocument(id: $id, name: $n, email: $e) {
        id
      }
    }
  `;
    ...
    check(res, {
        ...
        'same id returned' : (r) =>
            String(r.json('data.updateUserDocument.id')) === String(randomId),
    });
